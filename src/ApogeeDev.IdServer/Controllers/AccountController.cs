...
namespace ApogeeDev.IdServer.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<IActionResult> Logout(LogoutInputModel model)
        {
            ...
            IActionResult result = vm.AutomaticRedirectAfterSignOut ? (IActionResult)Redirect(vm.PostLogoutRedirectUri) : (IActionResult)View("LoggedOut", vm);
        ...
        private async Task<LoggedOutViewModel> BuildLoggedOutViewModelAsync(string logoutId)
        {
            ...
            if (User?.Identity.IsAuthenticated == true)
            {
                ...
                if (idp != null && idp != IdentityServer4.IdentityServerConstants.LocalIdentityProvider
                    && idp != GoogleOpenIdConnectDefaults.AuthenticationScheme)
                {
